...
<div style="margin:10px">
    ...
    <el-switch v-model="viewsource" inactive-text="查看原始json数据">
    </el-switch>
    <div style="margin:10px">
        <div style="width: 60%;float:left;">
            <el-table v-loading="listLoading" :data="json_show" style="width: 100%;" border :row-style="showRow" max-height="850">
        ...
        <div style="max-width:40%; height:850px;overflow:scroll;" v-if="viewsource">
